...
class Gui(tk.Tk):
    ...
    def __init__(self):
        ...
        # Index you're starting the results from and how many results you want in a page
    ...
    def load_frame(self, frame):
        """
        Changes the current visible frame to the given frame
    ...
    def search(self):
        ...
        """
        # Gives access to the Spotify API which has a searching function
        ...
        if spotify_type != '' and name != '':
            ...
            # Creates the respective SpotifyItems given the search
    ...
    def get_cover_img(self, url, size):
        ...
        :param url: The SpotifyAPI url that links to the desired image
